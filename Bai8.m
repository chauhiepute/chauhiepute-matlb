...
for t1=0:0.1:pi/2
    for t2=0:0.1:pi
        for t3=0:0.1:pi/6
            for t4=0:0.1:pi/6
                for t5=0:0.1:pi
                    Px= l1 - l5*(cos(t5)*sin(t1) + cos(t2 + t3 + t4)*cos(t1)*sin(t5)) + l6*sin(t2 + t3)*cos(t1) + l4*cos(t1)*cos(t2);
                    Py= l5*(cos(t1)*cos(t5) - cos(t2 + t3 + t4)*sin(t1)*sin(t5)) + l6*sin(t2 + t3)*sin(t1) + l4*cos(t2)*sin(t1);
                    Pz= l2 + l3 + l6*cos(t2 + t3) - l4*sin(t2) + l5*sin(t5)*(cos(t2 + t3)*sin(t4) + sin(t2 + t3)*cos(t4));
                    %plot3(Px,Py,Pz,'*');
                    hold on  
                end
            end
